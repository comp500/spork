...
import link.infra.spork.jfr.transformer.metadata.serialization.JFRMetadata;
import link.infra.spork.jfr.transformer.metadata.serialization.MetadataParser;
...
public class ChunkParser {
	...
	public static void read(RandomAccessFile file) throws IOException, TransformerParsingException {
		...
		//MetadataParser.read(file, header.useCompressedInts).metadata.classes;

		JFRMetadata meta = MetadataParser.read(file, header.useCompressedInts);
